...
const FILE_SPECS: readonly FileSpec[] = [
  ...
  { role: 'hillshade-raster', ext: 'Hillshade.tif', label: 'Hillshade raster', available: (a) => a.hillshade, desc: 'A shaded-relief image of the DTM (grey 0–255; NODATA where empty).' },
  { role: 'support-raster', ext: 'Support.tif', label: 'Support raster', available: (a) => a.support, desc: 'Per-cell support code: 2 measured, 1 interpolated, 0 unsupported.' },
  { role: 'uncertainty-raster', ext: 'Uncertainty.tif', label: 'Uncertainty raster', available: (a) => a.uncertainty, desc: 'Per-cell model confidence, 0–100 (higher = better supported); NODATA where no data.' },
