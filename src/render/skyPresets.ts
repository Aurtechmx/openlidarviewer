...
const SKIES: Readonly<Record<SkyPreset, SkyDefinition>> = {
  ...
  // Visuals Studio — Black flat sky for hero shots and screen-recording
  // compositing. Renders as a pure-black void so the cloud reads on a
  // backdrop the chroma key in any video editor can replace.
  black: {
    background: '#000000',
