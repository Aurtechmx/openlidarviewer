...
import { cellIndex, type GridCell } from '../flowPulse/flowGridCursor';
...
export { cellIndex, cellAt, clampCell, moveCursor, pixelToCell, type GridCell } from '../flowPulse/flowGridCursor';
...
/** Describe one cell from an already-built traversability map, for the live region. */
