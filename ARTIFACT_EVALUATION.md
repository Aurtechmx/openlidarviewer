...
This guide lets a reviewer evaluate the OpenLiDARViewer software artifact without special hardware or private data. It complements `REVIEWER_QUICKSTART.md` (fast start) and `docs/releases/VALIDATION_REPORT_v0.7.0-alpha.1.md` (what is and is not validated for this release; most terrain and measurement methods keep the evidence established in `VALIDATION_REPORT_v0.5.9.md`, and v0.6.9 changes the interactive stockpile estimator to `olv.volume.stockpile-area-grid`, as that report describes).
...
- `docs/releases/VALIDATION_REPORT_v0.7.0-alpha.1.md` lists exactly what was and was not tested for this release (most terrain and measurement methods keep the evidence established in `VALIDATION_REPORT_v0.5.9.md`; the interactive stockpile estimator changed to `olv.volume.stockpile-area-grid` in v0.6.9); `docs/validation/THREATS_TO_VALIDITY.md` aggregates the limitations.
