...
- `docs/releases/VALIDATION_REPORT_v0.6.9.md` lists exactly what was and was not tested for this release (most terrain and measurement methods keep the evidence established in `VALIDATION_REPORT_v0.5.9.md`; the interactive stockpile estimator changed to `olv.volume.stockpile-area-grid` in v0.6.9); `docs/validation/THREATS_TO_VALIDITY.md` aggregates the limitations.
