...
function rawCloud(n: number, schema: TileSchema): RawPoints {
  ...
  return {
    positions, intensity, classification, classificationFlags: new Uint8Array(n),
    returnNumber, returnCount,
    scanAngle: new Float32Array(n), userData: new Uint8Array(n),
    scannerChannel: new Uint8Array(n), scanDirection: new Uint8Array(n),
    edgeOfFlightLine: new Uint8Array(n),
    pointSourceId, gpsTime, colors, colors16: null,
  };
}
