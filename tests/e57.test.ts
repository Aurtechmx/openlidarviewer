...
// invalid-state column. `tests/bunnyFloat.e57` (OLV-DS-041) is committed under
// the libE57 Test Data License, which grants redistribution, and covers the same
// single-precision Float profile in `tests/e57DeclaredBounds.test.ts`.
...
// cartesian decode, and the bit-packed invalid-state column. The fixture is
// project-owned and committed, so these run in CI.
