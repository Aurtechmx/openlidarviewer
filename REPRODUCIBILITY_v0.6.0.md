...
| `test-evidence-v0.6.0.json` | attached to the release | **Yes** — generated by the exact-tag run |
...
| SBOM (CycloneDX, root `0.6.0`, production scope, 59 components) | `npx @cyclonedx/cyclonedx-npm --omit dev --output-file sbom.json` |
