...
recorded in `release-manifest-v0.6.2.json`, which ships with the release
...
`test-evidence-v0.6.2.json` (also a release asset). The committed copy under
`docs/validation/test-evidence.json` is marked non-authoritative and describes
development runs.

## What to read first

- `RELEASE_NOTES_v0.6.2.md`: what changed in this release.
- `VALIDATION_REPORT_v0.6.2.md`: what was and was not tested, and the honest gaps.
- `KNOWN_LIMITATIONS_v0.6.2.md`: the documented limits.
- `REPRODUCIBILITY.md` and `REPRODUCIBILITY_v0.6.2.md`: how to rebuild, test,
