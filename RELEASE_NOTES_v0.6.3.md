...
- five preset fields that declared a setting the renderer never applied are separated from the ones it does;
...
- five release gates escape every regular-expression metacharacter in a version, not only the dot;
