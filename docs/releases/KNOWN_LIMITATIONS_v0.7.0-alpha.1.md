...
`src/main.ts` is 4,854 lines and `src/render/Viewer.ts` is 6,136 eighty-seven lines
...
Fan-out is 106 for the shell, 76 for the renderer and 23 for the Analyse panel,
across 990 modules with no dependency cycles.
