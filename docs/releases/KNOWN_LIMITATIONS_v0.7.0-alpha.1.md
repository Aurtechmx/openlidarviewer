...
check drives real Mobile Safari and has not yet passed end to end. It
...
`src/main.ts` is 4,950 lines and `src/render/Viewer.ts` is 6,153, seventy lines
...
across 968 modules with no dependency cycles.
