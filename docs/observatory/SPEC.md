...
- OB-ST-01 One pure function maps counters to a state (§2.2 to 2.4), per source and in aggregate.
...
Each phase opens a ledger entry and closes it with evidence. v0.7 MUST covers O0 to O11. Later work is listed after the table.
...
- Medium: multi-station E57, 1 to 5M returns.
...
- F1 to F17 pass against the oracles.
