...
- TPI + six-class slope position (Weiss 2001): the neighbourhood radius targets ~10 m, clamped to 2 to 10 cells, with the achieved radius reported in cells and ground metres; TPI is in the grid's own Z units (stated), stdTPI and the classes are unit-free.
