...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 50k | 220 | 263 | 227,495 | 190,021 | 232 | 144 | 237 | 147 | 0.040 to 0.104 | 0.036 to 0.060 |
| 100k | 377 | 451 | 265,381 | 221,897 | 278 | 183 | 295 | 185 | 0.035 to 0.161 | 0.016 to 0.027 |
| 250k | 871 | 927 | 286,941 | 269,670 | 372 | 266 | 423 | 271 | 0.018 to 0.081 | 0.029 to 0.048 |
| 500k | 1865 | 1858 | 268,068 | 269,125 | 559 | 366 | 608 | 371 | 0.005 to 0.024 | 0.018 to 0.025 |
| 1M | 4684 | 4687 | 213,480 | 213,336 | 812 | 757 | 946 | 777 | 0.007 to 0.034 | 0.008 to 0.018 |
...
two modes' limb ranges (24.3 to 30.9 % and 18.6 to 23.8 %) do not overlap. They
...
an outlier-resistant band (within three interquartile ranges, or 5 % of the median) plus two
...
|---|---|---|---|---|---|---|
| v0.6.0 | (to be recorded at tag time) | n/a | n/a | n/a | n/a | n/a |
...
* Scheduler cadence. Mean tick wall-time stays under 80 ms even at
  ...
  this sandbox; at 250M it slips to ~20 to 30 fps cadence.
