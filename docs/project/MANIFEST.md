...
recorded in `release-manifest-v0.6.6.json`, which ships with the release
...
`test-evidence-v0.6.6.json` (also a release asset). The committed copy under
`docs/validation/test-evidence.json` is marked non-authoritative and describes
development runs.

## What to read first

- `docs/releases/RELEASE_NOTES_v0.6.6.md`: what changed in this release.
- `docs/releases/VALIDATION_REPORT_v0.6.6.md`: what was and was not tested, and the honest gaps.
- `docs/releases/KNOWN_LIMITATIONS_v0.6.6.md`: the documented limits.
- `REPRODUCIBILITY.md` and `docs/releases/REPRODUCIBILITY_v0.6.6.md`: how to rebuild, test,
