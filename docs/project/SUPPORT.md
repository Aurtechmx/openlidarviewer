...
OpenLiDARViewer is an actively maintained open-source project by Aurtech.

## Getting help
- **Questions and bug reports:** open a [GitHub issue](https://github.com/Aurtechmx/openlidarviewer/issues). Include what you expected, what happened, steps to reproduce, and your browser/OS/GPU and the file format if relevant.
- **General contact:** info@aurtech.mx.
