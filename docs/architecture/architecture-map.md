...
| UI | `src/ui` | ~34k | Panels, Inspector, Studio surfaces, onboarding. |
| Shell | `src/main.ts` | 4,969 | Wiring. **A monolith under decomposition.** |
...
**`src/main.ts` (4,969)** — the largest blocks, which are the extraction
candidates:
