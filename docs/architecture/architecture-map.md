...
| Shell | `src/main.ts` | 5,832 | Wiring. **A monolith under decomposition.** |
...
**`src/main.ts` (5,832)** — the largest blocks, which are the extraction
candidates:
...
**`src/render/Viewer.ts` (6,352)** — the constructor and a handful of large
methods dominate:
