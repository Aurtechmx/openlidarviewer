...
| Shell | `src/main.ts` | 5,818 | Wiring. **A monolith under decomposition.** |
...
**`src/main.ts` (5,818)** — the largest blocks, which are the extraction
candidates:
...
**`src/render/Viewer.ts` (6,336)** — the constructor and a handful of large
methods dominate:
