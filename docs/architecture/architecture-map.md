...
| Render | `src/render` | ~68k | three.js/WebGPU scene, streaming scheduler, measurement tools, colour modes. |
...
**`src/render/Viewer.ts` (6,174)** — the constructor and a handful of large
methods dominate:
