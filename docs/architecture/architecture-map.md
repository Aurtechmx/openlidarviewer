...
| Shell | `src/main.ts` | 5,558 | Wiring. **A monolith under decomposition.** |
...
**`src/main.ts` (5,558)** — the largest blocks, which are the extraction
candidates:
...
**`src/render/Viewer.ts` (6,424)** — the constructor and a handful of large
methods dominate:
