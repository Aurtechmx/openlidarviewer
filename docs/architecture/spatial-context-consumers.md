...
| 11 | GeoJSON / KML / DXF export | migrated | `src/main.ts`, `src/app/kmlActions.ts`, `src/export/scanFootprint.ts`, `src/ui/featureCandidatesMount.ts` | `isGeographic`, `verticalDatum`, `verticalMetresPerUnit`, `upAxis` |
