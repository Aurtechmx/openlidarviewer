...
- [VALIDATION_REPORT_v0.6.8.md](docs/releases/VALIDATION_REPORT_v0.6.8.md): what this release validates and what it does not. No product changed evidence level this cycle; the register holds 33 claims, 17 of them at E4 and none at E5, carried unchanged from [VALIDATION_REPORT_v0.6.7.md](docs/releases/VALIDATION_REPORT_v0.6.7.md).
