...
- [KNOWN_LIMITATIONS_v0.6.0-alpha.1.md](KNOWN_LIMITATIONS_v0.6.0-alpha.1.md) — the deliberate limits of this alpha (project frame staged, partial-match restore, PCD warning, residual flicker).
