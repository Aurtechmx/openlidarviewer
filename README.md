...
- [VALIDATION_REPORT_v0.7.0-alpha.1.md](docs/releases/VALIDATION_REPORT_v0.7.0-alpha.1.md): what this release validates and what it does not. No product changed evidence level this cycle; the register holds 36 claims, 17 of them at E4 and none at E5. One measurement method changed: the interactive stockpile volume is integrated over an area grid, and VOL-STOCKPILE stays at E3. Two new claims were added for Terrain Flow Pulse's depression inventory work (TERRAIN-FLOW-PULSE at E3, TERRAIN-FLOW-DEPRESSION-INVENTORY at E2); no existing claim's evidence level changed.
