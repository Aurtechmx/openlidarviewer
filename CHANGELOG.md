...
- The terrain and measurement algorithms are inherited from v0.6.5 unchanged, apart from the opt-in contour generalization mode above, which is off by default, and the change-volume band fix below.
